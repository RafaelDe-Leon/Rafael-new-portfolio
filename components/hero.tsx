        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">Rafael De Leon</h1>
              <p className="text-xl text-primary font-semibold tracking-wide">FULL STACK DEVELOPER</p>
              <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed mt-4">
                Building innovative web applications with cutting-edge design and robust functionality.
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              ...
              <ResumeHandler variant="outline" className="px-8 border-primary text-primary hover:bg-primary/10" />
            </div>
          </div>
